import{j as i}from"./jsx-runtime-D_zvdyIk.js";import{r as f,R as g}from"./iframe-Bj_fZlOo.js";import{d as $,l as o}from"./styled-components.browser.esm-BW9Cig6r.js";import{C as r}from"./Colors-BCsKZ4GV.js";import{s as y,a as v,c as w,C as k,T,b as C}from"./DefaultPropsProvider-7EA8HZRO.js";import{g as R}from"./memoTheme-DwCMIMd9.js";import{u as z}from"./useTheme-DaChCvKm.js";import{e as N}from"./extendSxProp-s4QnhW3V.js";import{C as B}from"./CircularProgress-CszZyRCI.js";function q(e={}){const{themeId:a,defaultTheme:u,defaultClassName:n="MuiBox-root",generateClassName:s}=e,c=y("div",{shouldForwardProp:t=>t!=="theme"&&t!=="sx"&&t!=="as"})(v);return f.forwardRef(function(p,m){const l=z(u),{className:x,component:h="div",...b}=N(p);return i.jsx(c,{as:h,ref:m,className:w(x,s?s(n):n),theme:a&&l[a]||l,...b})})}const M=R("MuiBox",["root"]),S=C(),j=q({themeId:T,defaultTheme:S,defaultClassName:M.root,generateClassName:k.generate}),W=(e,a)=>{if(a)switch(e){case"neutral":return o`
          &:disabled {
