import{j as v}from"./jsx-runtime-D_zvdyIk.js";import{r as h}from"./iframe-Bj_fZlOo.js";import{I as m}from"./index-DFmrWkD0.js";import"./styled-components.browser.esm-BW9Cig6r.js";import"./Colors-BCsKZ4GV.js";const b={placeholder:"Example",type:"text"},y={placeholder:"Enter text",type:"text",error:!0,errorMessage:"This field is required"},d={baseStyles:b,errorStyles:y},V={title:"Controls/Input",component:m,argTypes:{placeholder:{control:"text"},className:{control:"text"},style:{control:"object"},type:{control:"text"},disabled:{control:"boolean"},error:{control:"boolean"},errorMessage:{control:"text"},color:{control:"text"},borderColor:{control:"text"},maxLength:{control:"number"},value:{control:"text"},onChange:{action:"changed"},onBlur:{action:"blurred"},onFocus:{action:"focused"}}},i=e=>{const[g,x]=h.useState(e.value??"");return v.jsx(m,{...e,value:g,onChange:o=>{var a;(a=e.onChange)==null||a.call(e,o),x(o.target.value)}})},t=i.bind({});t.args={...d.baseStyles};const r=i.bind({});r.args={...d.errorStyles};var n,s,l;t.parameters={...t.parameters,docs:{...(n=t.parameters)==null?void 0:n.docs,source:{originalSource:`args => {
