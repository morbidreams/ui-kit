import{j as i}from"./jsx-runtime-D_zvdyIk.js";import{r as f,R as g}from"./iframe-CWrSSH7G.js";import{d as $,l as o}from"./styled-components.browser.esm-Bwj2GSdY.js";import{C as r}from"./Colors-BCsKZ4GV.js";import{s as y,a as v,c as w,C as k,T,b as C}from"./DefaultPropsProvider-Cab5bodk.js";import{g as R}from"./memoTheme-CuuAs1rV.js";import{u as z}from"./useTheme-CjKPuoQ3.js";import{e as N}from"./extendSxProp-BaYSA7Fr.js";import{C as B}from"./CircularProgress-l3PyrUzg.js";function q(e={}){const{themeId:a,defaultTheme:u,defaultClassName:n="MuiBox-root",generateClassName:s}=e,c=y("div",{shouldForwardProp:t=>t!=="theme"&&t!=="sx"&&t!=="as"})(v);return f.forwardRef(function(p,m){const l=z(u),{className:x,component:h="div",...b}=N(p);return i.jsx(c,{as:h,ref:m,className:w(x,s?s(n):n),theme:a&&l[a]||l,...b})})}const M=R("MuiBox",["root"]),S=C(),j=q({themeId:T,defaultTheme:S,defaultClassName:M.root,generateClassName:k.generate}),W=(e,a)=>{if(a)switch(e){case"neutral":return o`
          &:disabled {
